                ...
                <div className="space-y-6">
                  ...
                  <div className="glass-card p-6 rounded-3xl border border-gray-800 space-y-3 relative overflow-hidden">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      ...
                      <div className="flex items-center space-x-3">
                        <Link
                          href={`/reports/${selectedReport.id}/share`}
                          target="_blank"
                          className="flex items-center space-x-1.5 px-3.5 py-1.5 rounded-xl bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 font-semibold text-xs border border-indigo-500/30 transition-all"
                        >
